...
\begin{sidewaysfigure}
    \begin{center}
        \subfloat[Contador de estados.]{\label{fig:entrenamiento-contador-1}\includegraphics[width=.30\linewidth]{figures/chapter_5/simple_circuit_simple_1.png}}
        \hspace{0.1cm}
        \subfloat[Recompensa acumulada por episodio.]{\label{fig:entrenamiento-recompensa-1}\includegraphics[width=.30\linewidth]{figures/chapter_5/simple_circuit_simple_2.png}}
        \hspace{0.1cm}
        \subfloat[Pasos por episodio.]{\label{fig:entrenamiento-pasos-1}\includegraphics[width=.30\linewidth]{figures/chapter_5/simple_circuit_simple_3.png}}
    \end{center}
  \centering
...
\begin{sidewaysfigure}
    \begin{center}
        \subfloat[Recompensa acumulada por episodio.]{\label{fig:entrenamiento-recompensa-2}\includegraphics[width=.30\linewidth]{figures/chapter_5/nurburgring_medium_2.png}}
        \hspace{0.1cm}
        \subfloat[Pasos por episodio.]{\label{fig:entrenamiento-pasos-2}\includegraphics[width=.30\linewidth]{figures/chapter_5/nurburgring_medium_3.png}}
    \end{center}
  \centering
  \captionsetup{justification=centering,margin=2cm}
...
El resultado de esto son \textit{zig-zags} sobre la línea roja hasta que consigue estabilizar la dirección, en lugar de un movimiento más suave y paulatino como en el caso del PID. El tiempo de corrección hasta estabilizar el Fórmula-1 en el centro de la línea para un sistema PID es menor.\\
